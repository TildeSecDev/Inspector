...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function applyTerminalSettings(bg, fg, font) {
    ...
    // Apply to rxvt terminal if available
    if (window.term) {
  ...
  // Restore terminal settings on DOMContentLoaded, but defer applying to rxvt until it's ready
  window.addEventListener('DOMContentLoaded', () => {
    ...
    if (bg && fg && font) {
      ...
      // Only set input values here; actual terminal will be styled when rxvt is ready
    }
  });

  // Listen for custom event from rxvt terminal to apply settings after terminal is ready
  window.addEventListener('rxvt-ready', () => {
